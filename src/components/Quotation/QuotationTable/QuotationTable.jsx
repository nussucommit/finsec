...
export default function QuotationTable() {
    ...
    return (
      <div>
        <div style={{marginLeft: 15, marginRight: 15, marginTop: 10, marginBottom: 10}}>
            <Grid container>
                <Grid item xs={12} sm={12} container zeroMinWidth>
                    ...
                    <div style={{ height: 460, width: '100%' }}>
                        <DataGrid rows={rows} columns={columns} pageSize={5} checkboxSelection onRowClick={handleOpen}
                            components={{
